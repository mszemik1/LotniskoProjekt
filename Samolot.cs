...
namespace lotnisko
{
    public abstract class Samolot 
    {
        ...
        public double stanPaliwa; // ile kg paliwa jest obecnie
        List<Bagaz> bagaze;
        ...
        public void ZaladunekBagazy(bool verbose = false)
        {
            ...
            sb.AppendLine($"Załadowano {LiczbaBagazy(enumRodzajBagazu.rejestrowany)} bagaży rejestrowanych i " +
                $"{LiczbaBagazy(enumRodzajBagazu.podreczny)} podrecznych.");
        ...
        public void LosujLot(bool czyPrzylot= true)
        {
            ...
            {
                lot = new Lot(miasto, czasLotu, bazowaCena, "Przygotowanie do lotu");
            }
        }
    } 
